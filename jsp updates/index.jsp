              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-1">
                    ...
                    Checked Baggage allowance | I already have a ticket. How can I check my baggage allowance?
                  </button>
                </h3>
                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Your baggage allowance is indicated on your e-ticket as shown below.
                    Please note that certain travel documents from your travel agents may 
                    have this in a different format.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                    <i class="bi bi-question-circle question-icon"></i>
                    Can I hold my booking for later payment?                  </button>
                </h3>
      ...
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-info">
          ...
          <p>A full service airline typically offers passengers in flight entertainment,checked baggage, meals,
            beverages and comforts such as blankets and pillows in the ticket price. The seats generally
             have more recline than a low cost carrier as well as more leg room.</p>
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          ...
          <p>
            ...
            Sri Lanka <br><br>
            <strong>Phone:</strong> +94 5589 55488 55<br>
