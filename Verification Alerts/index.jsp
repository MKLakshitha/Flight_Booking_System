		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<!-- LOGOUT triggers the logout.java -->
					<li class="nav-item mx-0 mx-lg-1 bg-danger"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="index.jsp">Account JSP page please</a></li>
					<!-- ADD A DROPDOWN KIND OF THING HERE <<Account Details I guess>> -->
				</ul>
			</div>
		</div>
	</nav>
