 ...
 <svg
  ...
  <p id="errorText"> <div class="m-4">
    <div class="alert alert-danger alert-dismissible fade show">
        ...
        <p>Please enter a different Date or Different Destination to make that your trip Quick. If you need any help just place the mouse pointer above info icon next to the form field.</p>
        <hr>
