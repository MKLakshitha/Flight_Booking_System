                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex">
                                            <div>
                                                <h4 class="card-title">User Last Login Details</h4>
                                                <h5 class="card-subtitle" style="font-size:14px">Overview of Users Last Login and IP Addresses</h5>
                                            </div>
                                            <div class="ms-auto">
                                                <div class="dl">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-0 table-hover align-middle text-nowrap" id="example">
                                                <thead>
													...
													<th class="border-top-0">Last Login <i class="mdi mdi-alarm"></i></th>
												<th class="border-top-0">IP Address <i class="mdi mdi-alert-octagram"></i></th>
												<th class="border-top-0">Host Name <i class="mdi mdi-bookmark"></i></th>
    ...
    width: 70%;
                                                ...
                                                <%while(rs.next()){
                                                    ...
                                                    <tr>
        												...
        												<td><p class="badge bg-secondary" ><%=rs.getString("lastLogin") %></p></td>
        									        <td><h6  style="font-size:12px;" class="badge bg-warning" style="font-size:16px;"><%=rs.getString("IP") %></h6></td>
        										        <td><h6  style="font-size:12px;"><%=rs.getString("Hostname") %></h6></td>
