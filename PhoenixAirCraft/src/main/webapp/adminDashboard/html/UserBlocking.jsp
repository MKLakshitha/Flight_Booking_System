                                                ...
                                                <thead>
                                                    <tr>
													   ...
													   <th class="border-top-0">Edit <i class="mdi mdi-ethernet-cable-off"></i></th>
														...
														<th class="border-top-0">Unblock <i class="mdi mdi-account-plus"></i></th>
			  ...
			  color:gray;
                                                    ...
                                                    <tr>
        										     ...
        										     <td><a href="#popup2"><img src="../assets/img/icons8-edit-64.png" style="width:40px; height:40px;"></a></td>
        										       ...
        										       <td><a href="../../Unblock?id=<%=rs.getString("memberID") %>"><img src="../assets/img/icons8-unlock-private-48.png" style="width:40px; height:40px; margin-left:20px;"></a></td>
                                                <td><a href="../../DeleteUsers?id=<%=rs.getString("memberID") %>" id=""><img src="../assets/img/icons8-delete-100.png" style="width:40px; height:40px; margin-left:10px;"></a></td>
